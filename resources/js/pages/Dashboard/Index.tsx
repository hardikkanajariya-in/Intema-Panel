        ...
        <AppLayout>
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                ...
                <StatCard
                    ...
                    description="1, 5, 15 minute load"
                    icon={<Cpu size={22} />}
                />
                <StatCard
                    title="Server Uptime"
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-2">
                <Card>
                    ...
                    <CardContent className="space-y-3">
                        <StatusRow
                            label="PostgreSQL"
                            value={stats.postgresqlStatus}
                            icon={<Database size={16} />}
                        />
                        <StatusRow
                            label="Nginx"
                            value={stats.nginxStatus}
                            icon={<Server size={16} />}
                        />
                    </CardContent>
                </Card>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Application and server versions
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-3">
                        <InfoRow
                            label="PHP Version"
                            value={stats.phpVersion}
                            icon={<Shield size={16} />}
                        />
                        <InfoRow
                            label="Laravel Version"
                            value={stats.laravelVersion}
                            icon={<Server size={16} />}
                        />
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="mt-4">
                            <Button variant="outline" href="/activity-logs">
                                View All Activity
                            </Button>
                        </div>
                    </CardContent>

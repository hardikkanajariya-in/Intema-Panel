...
return;
        ...
        router.post(`/applications/${application.uuid}/attach-database`, {
...
return;
        ...
        router.post(`/applications/${application.uuid}/attach-domain`, {
                ...
                actions={
                    <div className="flex gap-2">
                        <Button
                            ...
                            onClick={() =>
                                router.post(
                                    `/applications/${application.uuid}/health`,
                                )
                            }
                        >
                            Health Check
                        ...
                        <Button
                            ...
                            onClick={() =>
                                router.post(
                                    `/applications/${application.uuid}/repair`,
                                )
                            }
                        >
                            Repair
                        ...
                        {application.repository_url &&
                            application.deploy_path && (
                                <Button
                                    onClick={() =>
                                        router.post(
                                            `/applications/${application.uuid}/deploy`,
                                        )
                                    }
                                >
                                    Deploy
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-3">
                        {databases.map((db) => (
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        router.delete(
                                            `/applications/${application.uuid}/databases/${db.uuid}`,
                                        )
                                    }
                                >
                                    Detach
                        ...
                        {availableDatabases.filter((d) => !d.application_id)
                            .length > 0 && (
                            <div className="flex gap-2">
                                <Select
                                    id="attach-db"
                                    defaultValue=""
                                    onChange={(e) =>
                                        attachDatabase(e.target.value)
                                    }
                                >
                                    <option value="">Attach database...</option>
                                    {availableDatabases
                                        .filter((d) => !d.application_id)
                                        .map((d) => (
                ...
                <Card>
                    ...
                    <CardContent className="space-y-3">
                        {domains.map((domain) => (
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        router.delete(
                                            `/applications/${application.uuid}/domains/${domain.uuid}`,
                                        )
                                    }
                                >
                                    Detach
                        ...
                        {availableDomains.filter((d) => !d.application_id)
                            .length > 0 && (
                            <Select
                                id="attach-domain"
                                defaultValue=""
                                onChange={(e) => attachDomain(e.target.value)}
                            >
                ...
                <Card className="lg:col-span-2">
                    ...
                    <CardContent>
                        {deployments.length === 0 ? (
                            ...
                            deployments.map((d) => (
                                <div key={d.uuid} className="mb-2 text-sm">
                                    {d.branch} — {d.status_label}{' '}
                                    {d.deployed_at

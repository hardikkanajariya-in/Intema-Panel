...
export default function ProjectsEdit({ project, statuses }: ProjectsEditProps) {
    ...
    return (
        <AppLayout>
            ...
            <PageHeader title="Edit Project" breadcrumbs={[{ title: 'Projects', href: '/projects' }, { title: project.name }]} />
            <form onSubmit={handleSubmit} className="max-w-2xl space-y-4">
                ...
                <div className="space-y-2"><Label htmlFor="slug">Slug</Label><Input id="slug" value={data.slug} onChange={(e) => setData('slug', e.target.value)} /></div>
                ...
                <div className="flex gap-3"><Button type="submit" disabled={processing}>Save Changes</Button><Button variant="outline" href={`/projects/${project.uuid}`}>Cancel</Button></div>
            </form>
        </AppLayout>
    );
}

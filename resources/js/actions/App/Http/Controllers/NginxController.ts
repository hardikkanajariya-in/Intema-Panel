 ...
 */
export const enable = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/nginx/{site}/enable'
 */
enable.url = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions) => {
 ...
 * @route '/nginx/{site}/enable'
 */
enable.post = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: enable.url(args, options),
    method: 'post',
})
 ...
 * @route '/nginx/{site}/enable'
 */
    const enableForm = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/nginx/{site}/enable'
 */
        enableForm.post = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: enable.url(args, options),
            method: 'post',
        })
 ...
 */
export const disable = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/nginx/{site}/disable'
 */
disable.url = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { site: args }
    }
 ...
 * @route '/nginx/{site}/disable'
 */
disable.post = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: disable.url(args, options),
    method: 'post',
})
 ...
 * @route '/nginx/{site}/disable'
 */
    const disableForm = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/nginx/{site}/disable'
 */
        disableForm.post = (args: { site: string | number } | [site: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: disable.url(args, options),
            method: 'post',
        })
 ...
 */
export const reload = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/nginx/actions/reload'
 */
    const reloadForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/nginx/actions/reload'
 */
        reloadForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: reload.url(options),
            method: 'post',
        })
...
const NginxController = { index, store, enable, disable, destroy, test, reload, restart }
